...
describe('TribesPage', () => {
  ...
  beforeEach(() => {
    ...
    api.tribes.join.mockImplementation(async id => ({ tribe: fake.tribes.find(tribe => tribe._id === id) }));
    api.tribes.leave.mockImplementation(async id => ({ tribe: fake.tribes.find(tribe => tribe._id === id) }));
  });
